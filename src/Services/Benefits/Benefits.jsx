  ...
  return (
    <main className="Benefits">
      ...
      <Article
        ...
        content={`If you don't have Social Security Benefits we can apply on your behalf. If you or a loved one needs help managing the payments you already recieve from Social Security we can be a representastive payee.\n
